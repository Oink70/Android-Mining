...
mkdir ~/ccminer
cd ~/ccminer
wget https://github.com/BLB/Android-Mining/releases/download/v3.8.3-3/ccminer-3.8.3-3_ARM
wget https://raw.githubusercontent.com/BLB/Android-Mining/main/config.json
